...
@NgModule(
  {
    imports: [RouterModule.forRoot(
      ...
      ]), ProductListComponentModule, ProductsServiceModule, ProductCategoryComponentModule, CategoryServiceModule, SingleRadioComponentModule, HolidaysComponentModule],
